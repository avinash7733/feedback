...
if(isset($_POST['sub']))
{
  ...
  $quest8=$_POST['quest8'];
  $quest9=$_POST['quest9'];
$query="INSERT INTO labss(q1,q2,q3,q4,q5,q6,q7,q8,q9)values('$quest1','$quest2','$quest3','$quest4','$quest5','$quest6','$quest7','$quest8','$quest9')";
...
<td><h3>LAB codes as per syllabus:</h3></td>
  <td><h3><u> <center>LAB 2</center></u></h3></td> 
